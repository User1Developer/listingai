...
1. Lead with the neighborhood lifestyle and school district if mentioned
2. Emphasize space: bedrooms, yard, garage, storage
3. Highlight safety, walkability, proximity to parks, schools, and community
4. Feature practical upgrades: new roof, HVAC, updated kitchen
...
Power phrases: "top-rated schools", "cul-de-sac", "entertainer's backyard", "move-in ready", "walkable to".`,

    luxury: `You are writing for a LUXURY property listing. Your priorities in order:
1. Open with the most distinctive feature in evocative language
2. Emphasize quality of finishes: materials, brands, craftsmanship
3. Create lifestyle imagery: morning coffee with canyon views, hosting in the chef's kitchen
4. Privacy, exclusivity, and prestige
...
Power phrases: "bespoke", "resort-style", "curated", "panoramic", "chef-caliber", "rare offering", "discerning buyer".`,

    investment: `You are writing for an INVESTMENT PROPERTY listing. Your priorities in order:
1. Lead with the financial story — calculate and surface cap rate, cash flow, GRM if data is present
2. If monthly rent is mentioned: calculate annual gross income, estimate cap rate if price given
3. Highlight tenant situation: occupied/vacant, lease terms
4. Location drivers: job centers, transit, rental demand
5. Value-add upside: what can be improved or repositioned
6. Close with the investment thesis in one sentence
NEVER bury the numbers. NEVER write like a retail home listing.`,

    fixer: `You are writing for a FIXER-UPPER / OPPORTUNITY listing. Your priorities in order:
1. Lead with location and land value
2. Frame condition as opportunity: "blank canvas", "priced for the work"
3. Highlight the bones: lot size, layout, sqft, structural positives
4. Mention neighborhood trajectory
5. When price and comps are both available, always frame the spread as opportunity: "Priced at $X with updated comps at $Y — the difference is your equity"
6. Never list negatives consecutively — sandwich condition acknowledgment between positives
NEVER hide condition. NEVER say "priced to reflect condition" — show the math instead.
...
  return `You are an elite real estate copywriter with 20 years of experience writing listing copy that sells homes faster and for more money.
...
- Be specific: "quartz waterfall island" not "updated kitchen"
- MLS copy: 150-180 words maximum
...
- Email: under 150 words, format as "Subject: [line]" then double line break then body
- Zillow: 100-130 words, lead with bedroom/bathroom count and key features
...
        :root {
          --bg: #0a0908; --surface: #131110; --surface2: #1a1714;
